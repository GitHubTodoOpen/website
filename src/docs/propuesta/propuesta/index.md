---
title: Propuesta
short-title: Propuesta
description: Propuesta del proyecto.
diff2html: true

---
<button type="button" onclick="printJS(
    { printable: 'contenido-div', 
      type: 'html', 
      ignoreElements:['section-nav','contenido-ul-section-nav-sv', 'contenido-ul-section-nav
      ', 'contenido-ul-nav', 'contenido-ul', 'site-content__title', 'menu-izq'] 
    })">
...
## Alcance
Desarrollar una aplicación de escritorio, para la evaluación de riesgo en función al registro de correspondencia y
 valoraciones de indicadores de riesgo parametrizables.
 
## Objetivos
* Desarrollar la aplicacion de escritorio para sistema operativo Windows y Mac
* Disenar 


El alcance del software se describe a continuación:
